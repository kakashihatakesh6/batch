...
const Hero: React.FC<HeroProps> = ({ headline, subheadline, ctaButtons }) => {
  return (
    <div className="font-style pt-[73px]">
      <img className="flex relative rotate-45 w-[48px] h-[48px] top-[30px] mx-7" src="https://iili.io/JbE3pDu.png" alt="Hero Logo" />
      <div className="md2:grid grid-cols-2 w-screen mb-10 lg2:m-10 m-5 flex justify-center flex-wrap">
        <div className="flex flex-col md2:items-start items-center ml-0 md:ml-[35px]">
          <div
          ...
          >
            <div className="bold text-[44px] font-style m-1  flex justify-center mt-10">{headline}</div>
        ...
        <div
          className="md2:w-[520px] lg2:w-[650px] w-[450px] flex items-start justify-start "
          style={{
            backgroundImage: "url(https://iili.io/JbX0k0u.png)",
            backgroundSize: "contain",
        ...
        >
          <div className="flex w-[550px] md:w-[725px] md:h-[725px]">

            <img src="https://iili.io/JbtIcFe.png" className="rotate-180 duration-500 hover:scale-110 object-cover" alt="Image 1" />
          </div>
        </div>
      </div>
    </div>
